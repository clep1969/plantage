<?php
	...
	***/
	...
	$db = mysql_connect ("localhost","plantage","66Tcca") or die ("<b>Error #".mysql_errno().":</b> ".mysql_error().".");
	mysql_select_db ("plantage_plantage",$db) or die ("<b>Error #".mysql_errno().":</b> ".mysql_error().".");
